<template>
    <v-card max-width="1000px" hover title="Responsables" color="pink-lighten-5">
      ...
      <v-data-table density="compact" 
        ...
        :items="datos" 
        :search="search"
        :sort-by="[{ key: 'id', order: 'asc' }]" :sort-by1="[{ key: 'numEmpleado', order: 'asc' }]"
        :sort-by2="[{ key: 'nombre', order: 'asc' }]"></v-data-table>
  
  
      <v-dialog v-model="showDeleteDialog" max-width="500px">
        <v-card color="red-lighten-5">
          <v-card-title>Eliminar Responsable</v-card-title>
          <v-card-text>
            <v-text-field 
      ...
      <v-dialog v-model="showUpdateDialog" max-width="500px">
        <v-card color="amber-lighten-5">
          <v-card-title>Actualizar Responsable</v-card-title>
          <v-card-text>
  ...
  const headers = ref([
    ...
    { key: 'numEmpleado', title: 'No. Empleado' },
